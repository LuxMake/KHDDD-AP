...
function LocationDefs:DefineWorldEvents()
  ...
  --Flashback: Mark of Mastery
    ...
    --Ansem Bonuses
    {ID=2670296, StoryBit = {0x01, 0xFF, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00}, LookAt=0x03, Popup=false, worldNo=0x0A, char=1, sent = false}, --Ansem I defeated
    {ID=2670297, StoryBit = {0x01, 0xFF, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00}, LookAt=0x03, Popup=false, worldNo=0x0A, char=1, sent = false} --ABCN Defeated
}
